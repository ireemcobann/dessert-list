    ...
    productList.innerHTML += `
        <div class="products-grid-item">
          <div class="image-container">
             ...
             <button data-irem="${product.name}" class="sepete-ekle"><i class="fa-solid fa-cart-plus"></i>Add to cart</button>
          </div>
...
function removeOrder() {
  ...
  const tiklananUrunIndex = orders.findIndex(order => order.name == tiklananUrun)
